...
- [x] Add charts using Recharts (implemented in `src/components/MetricsDashboard.tsx` with 7-day trend + status bar chart)

### Week 11-12: Polish

- [x] Mobile responsive layout
- [x] Keyboard shortcuts (discoverability + conflict-safe bindings: global Shift+N, in-board N, ? help dialog)
- [x] Task search and filter
- [x] Export tasks to CSV (wired UI export button to `/api/tasks/export`, including active filters + robust CSV output)
